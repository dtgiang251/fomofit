        ...
        for ($i = 1; $i <= 2; ++$i) {
            ...
            foreach ($languages as $language) {
				...
				if($i==1){
					...
					<p class="title1" data-animation="animated fadeInLeft">Cooking made <br /> Super easy</p>
					<p class="title2" data-animation="animated fadeInRight"><span>20%</span> Off <br />Premium cookers</p>
					...
					<p class="title1" data-animation="animated fadeInLeft">ceramic <br /> Cookware</p>
					<p class="title2" data-animation="animated fadeInRight">Get cooking with pro tools</p>
					<p class="readmore" data-animation="animated zoomIn"><a href="#"><span>Shop now</span></a></p>
					</div>';
				}else{
