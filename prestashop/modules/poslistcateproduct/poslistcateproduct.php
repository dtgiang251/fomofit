	...
	protected function installDemoData()
	{
		...
		for ($i = 1; $i <= 2; ++$i)
		{
			...
			foreach ($languages as $language)
			{
				...
				if($i==1){
					$item->description[$language['id_lang']]='<div class="thumb-images">
					<div class="banner-box"><a href="#"><img src="/pos_angara_1.7/img/cms/thumb_1.jpg" alt="" /></a></div>
					</div>';
				}elseif($i==2){
					$item->description[$language['id_lang']]='<div class="thumb-images">
					<div class="banner-box"><a href="#"><img src="/pos_angara_1.7/img/cms/thumb_2.jpg" alt="" /></a></div>
					</div>';
				}else{
