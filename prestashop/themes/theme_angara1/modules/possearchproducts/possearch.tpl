...
<div id="pos_search_top" class="col-lg-9 col-md-9 col-sm-12 col-xs-12">
	<form method="get" action="{$search_controller_url}" id="searchbox" class="form-inline form_search"  data-search-controller-url="{$url_search|escape:'html'}">
		...
		<input type="text" name="s" value="{$search_string}" placeholder="{l s='Enter a keyword to search' mod='possearchcategories'}" id="pos_query_top" class="search_query form-control ac_input" >
